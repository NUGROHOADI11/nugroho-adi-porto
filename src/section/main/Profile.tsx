      ...
      <div className="relative w-full h-[100vh]">
        ...
        <div className="absolute inset-0 p-8 md:p-16 flex flex-col justify-between">
          <div className={ANIMATION_CLASSES.SCROLL_ANIMATE}>
            <h2 className="text-7xl sm:text-8xl md:text-9xl lg:text-[12rem] tracking-tight font-medium leading-none text-white absolute inset-0  left-[5%] -top-44">
              Way of <br /> Thinking
            </h2>
          </div>
          <div
          ...
          >
            <p className="max-w-2xl text-gray-200 text-lg md:text-xl tracking-tight ">
              A results-driven and forward-thinking final-year Informatics
              student <br /> at the University of Muhammadiyah Malang with a
            ...
            <h1 className="text-5xl md:text-7xl text-white underline underline-offset-0 [text-decoration-skip-ink:none]">
              Profile
            </h1>
          </div>
        </div>
